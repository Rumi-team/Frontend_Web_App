      ...
      <div className="relative w-full max-w-md p-6 bg-gray-900 rounded-lg shadow-xl">
        ...
        {formState?.success ? (
          <div className="text-center py-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-green-100 text-green-500 mx-auto mb-4">
              <svg
            ...
            <Button onClick={onClose} className="bg-yellow-400 text-black hover:bg-yellow-300">
              Close
            </Button>
          </div>
        ) : (
          <form action={formAction} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                required
                className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-yellow-400 resize-none"
